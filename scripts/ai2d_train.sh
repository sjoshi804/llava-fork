...
RUN_ID=ai2d_gen_task_desc_50k_middle_ppl.json
...
TRAIN_DATA_PATH=/home/sjoshi/llava-fork/mminstruct_data/ai2d_gen_task_desc_75k_high_loss.json
RUN_ID=ai2d_gen_task_desc_75k_high_loss
